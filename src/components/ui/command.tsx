  ...
  return (
    <Dialog {...props}>
      <DialogHeader className='sr-only' aria-describedby={undefined}>
        ...
        {/* Added DialogDescription to skip warning: Missing Description or aria-describedby={undefined} */}
        <DialogDescription />
      </DialogHeader>
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      'overflow-hidden p-1 text-foreground **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:capitalize **:[[cmdk-group-heading]]:text-muted-foreground',
      className,
    )}
    {...props}
  />
